...
!!! note 
For the EBB SB2209 CAN V1.0 (RP2040) structure details, refer to: [EBB SB2209 CAN V1.0 (RP2040).PDF](https://github.com/bigtreetech/EBB/blob/master/EBB%20SB2209%20CAN%20(RP2040)/Build%20Guide/EBB%20SB2209%20CAN%20V1.0%EF%BC%88RP2040%EF%BC%89Build%20Guide_20250508.pdf)

## **Product Overview**

- Included components: Highlighted in blue (see image).
- Not included: Voron StealthBurner accessories (highlighted in red) must be purchased separately.
...
- RP2040 microcontroller with CAN bus support

- Compatible with Voron StealthBurner toolhead

- Onboard stepper driver (TMC2209)

## Software Setup

### Flashing Katapult (Optional)

!!! info "Katapult (formerly CanBoot)"
    `Katapult` is the New Name for `CanBoot` 

    Katapult enables firmware updates via CAN bus. Skip this step if using DFU updates.
...
4. Flash Katapult using DFU
    ...
    2. Hold Boot button and press Reset to enter DFU mode.
...
**Need help? Submit a support ticket for product assistance:**
