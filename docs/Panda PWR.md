...
## Packaging List
<img src=img/PandaPWR/packaging.webp width="600"/>
...
* To modify the IP address, click the "Configure Wi-Fi" button.<br><img src=img/PandaPWR/check_ip.webp width="400"/>
...
Click the "Factory Reset" button to restore the factory settings.<br><img src=img/PandaPWR/factory.webp width="400"/>
Method 2:
...
* Click the "Reset Usage" button to clear the power consumption data.<br><img src=img/PandaPWR/ctl_btn.webp width="400"/>
...
<img src=img/PandaPWR/ota_ok.webp width="400"/>
