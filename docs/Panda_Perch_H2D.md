...
* **Step 2: Attach the Top Panel**

    Secure the top panel to the main frame using CM3x4 screws, ensuring the raised side is facing upward.
...
## RGB Light Strip Installation Guide

* **Step 1: Print the RGB Light Strip Support Bar and Clips**
