...
如果您的任何P1P/S打印机未设置为“仅局域网”模式，则您需要通过panda touch启用与它们的云模式，以控制以下功能：
*加热
*开始打印
*暂停打印
*停止打印

按照以下步骤启用与需要它的打印机的云模式。
...
* 如果您找不到登录凭据，请参阅以下部分：[帮助 如何找到我的 拓竹账号信息](#帮助-如何找到我的-拓竹账号信息)
...
* 我们建议只有当您的所有机器都使用云模式运行时，才转换所有打印机。 如果使用仅局域网模式，则最好手动将每台机器设置为云模式，如中所述 [切换工作模式指南](#如何在-PandaTouch-和打印机之间切换工作模式)。
