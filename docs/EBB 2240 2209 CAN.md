...
<img src=img/EBB2240_2209/EBB2240_2209_Title.webp width="600"/>
...
=== "EBB SB2240 V1.0"
    <img src=img/EBB2240_2209/EBB2240_Dimensions.webp width="450"/>

=== "EBB SB2209 V1.0"
    <img src=img/EBB2240_2209/EBB2209_Dimensions.webp width="450"/>

## Pinout

=== "EBB SB2240 V1.0"
    <img src=img/EBB2240_2209/EBB2240_Pin.webp width="450"/>

=== "EBB SB2209 V1.0"
    <img src=img/EBB2240_2209/EBB2209_Pin.webp width="450"/>
...
<img src=img/EBB2240_2209/EBB2240_USB.webp width="450"/>

### Download firmware using DFU

<img src=img/EBB2240_2209/EBB2240_DFU.webp width="600"/>
...
<img src=img/EBB2240_2209/EBB2240_5569.webp width="450"/>
...
<img src=img/EBB2240_2209/EBB2240_PT1000_Connection.webp width="600"/>
...
<img src=img/EBB2240_2209/EBB2240_BLtouch.webp width="500"/>

### **Proximity Switch Connection**

1. The wiring diagram of proximity switch is shown as follows

    <img src=img/EBB2240_2209/EBB2240_Proximity.webp width="500"/>
...
2. Wiring switch voltage selection
    ...
    <img src=img/EBB2240_2209/EBB2240_Proximity1.webp width="500"/>
...
3. Use `+5V` to power the proximity switch
    ...
    <img src=img/EBB2240_2209/EBB2240_Proximity2.webp width="500"/>
...
4. Use `12V` to power the proximity switch
    ...
    <img src=img/EBB2240_2209/EBB2240_Proximity3.webp width="500"/>
    ...
    !!! warning 
        ...
        <img src=img/EBB2240_2209/EBB2240_Proximity4.webp width="500"/>
...
5. Proximity switch type selection
    ...
    <img src=img/EBB2240_2209/EBB2240_Proximity5.webp width="500"/>
...
<img src=img/EBB2240_2209/EBB2240_CANBUS1.webp width="500"/>

<img src=img/EBB2240_2209/EBB2240_CANBUS2.webp width="500"/>
...
<img src=img/EBB2240_2209/EBB2240_FAN3.webp width="500"/>
...
!!! warning 
    ...
    <img src=img/EBB2240_2209/EBB2240_FAN4.webp width="500"/>

### CAN connection with BIGTREETECH EBB SB0000

<img src=img/EBB2240_2209/EBB2240_SB0000.webp width="500"/>
...
<img src=img/EBB2240_2209/EBB2240_RGB.webp width="500"/>
...
<img src=img/EBB2240_2209/EBB2240_NCPin.webp width="500"/>
...
<img src=img/EBB2240_2209/EBB2240_Linear.webp width="500"/>
...
2. Config Katapult
    ...
    <img src=img/EBB2240_2209/EBB2240_Software12.webp width="500"/>
...
3. Build Katapult
    ...
    <img src=img/EBB2240_2209/EBB2240_Software13.webp width="500"/>
...
4. Please use a Type-C cable to connect the EBB SB2240/2209 CAN to the Raspberry Pi/CB1, and ensure that the USB_5V jumper is connected, in order to supply power to the EBB SB2240/2209 CAN via Type-C.
    ...
    <img src=img/EBB2240_2209/EBB2240_Software17.webp width="500"/>

5. Press and hold the Boot button, and then click the Reset button to enter the DFU mode.

    <img src=img/EBB2240_2209/EBB2240_Software18.webp width="500"/>
...
6. Enter in the SSH terminal command line
    ...
    <img src=img/EBB2240_2209/EBB2240_Software19.webp width="500"/>
...
<img src=img/EBB2240_2209/EBB2240_Software20.webp width="600"/>
...
2. Use command below to find `canbus_uuid`
    ...
    <img src=img/EBB2240_2209/EBB2240_Software21.webp width="500"/>
...
3. Use command below to flash klipper via Katapult
    ...
    <img src=img/EBB2240_2209/EBB2240_Software22.webp width="500"/>
...
4. Use command below to check application running in EBB CAN.
    ...
    <img src=img/EBB2240_2209/EBB2240_Software23.webp width="450"/>
...
<img src=img/EBB2240_2209/EBB2240_Software17.webp width="600"/>

2、Press and hold the Boot button, and then click the Reset button to enter the DFU mode.

<img src=img/EBB2240_2209/EBB2240_Software18.webp width="600"/>
...
<img src=img/EBB2240_2209/EBB2240_Software19.webp width="600"/>
