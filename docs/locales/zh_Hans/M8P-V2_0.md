...
4.4.2中下载的DSI1驱动也带有了CSI1的驱动，如果不想安装DSI1的驱动，只想安装CSI1的驱动，在https://datasheets.raspberrypi.com/licence.html找到想使用的驱动，下载到CM4的boot文件夹中并重命名为 dt-blob.bin，然后参考此处设置使用即可
